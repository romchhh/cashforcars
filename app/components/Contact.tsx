        ...
        <div className="relative bg-white rounded-[2.5rem] shadow-2xl overflow-hidden">
          ...
          <div className="relative h-[420px] md:h-[360px] z-0">
            <Image
              ...
              alt="Contact background with car steering wheel"
              fill
            ...
            <div className="w-full max-w-[900px] mx-auto px-6 md:px-12">
              <div className="max-w-xl">
                ...
                <p
                  ...
                  style={{ fontFamily: 'Corbel, sans-serif' }}
                >
                  Have questions or need help choosing the right option? Use the quote form above to share your vehicle
                  details and our team will get back to you with next steps.
                </p>
                <Link
                  href="/get-offer"
                  className="inline-flex items-center justify-center px-8 py-3.5 rounded-lg bg-white text-[#222221] font-semibold text-sm md:text-base shadow-lg hover:shadow-xl hover:bg-[#F9DC0A] transition-all"
                  style={{ fontFamily: 'Corbel, sans-serif' }}
                >
                  Go to Get A Quote Form
                </Link>
              </div>
            </div>
          </div>
